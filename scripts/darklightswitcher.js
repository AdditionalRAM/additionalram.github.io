...
$(document).on("headerLoaded", () => {
    ...
    normalNavbarColor = document.querySelector(".navbar").style.color;
    darkButton = document.querySelector('#darkmode');
    updateColors();
...
function updateColors() {        
    if (darkMode) {
        ...
        // header.style.backgroundImage = "linear-gradient(180deg, var(--background-color1), var(--accent-green))";
        header.style.backgroundImage = "linear-gradient(180deg, #000000, #32CD32)";
        // if imaddram exists
        if(document.querySelector(".im-addram.big"))
        document.querySelector(".im-addram.big").style.backgroundImage = "linear-gradient(45deg, var(--accent-blue), var(--accent-lime))";
        ...
        // change background linear gradient of header
        const header = document.querySelector("#header-holder");
        header.style.backgroundImage = "linear-gradient(180deg, #00000044, #32CD3255)";
        if(document.querySelector(".im-addram.big"))
        document.querySelector(".im-addram.big").style.backgroundImage = `linear-gradient(45deg, ${darkColors[2]}, var(--accent-lime))`;
    }
